...
def get_forecast_summary(lat, lon):
    ...
    url = "https://api.open-meteo.com/v1/forecast?latitude=" + (lat) + "&longitude=" + str(lon) + "&hourly=temperature_2m,precipitation,precipitation_type&forecast_days=2&timezone=America%2FNew_York"
